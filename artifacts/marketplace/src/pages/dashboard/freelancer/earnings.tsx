          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow><TableCell colSpan={5} className="text-center py-8">No earnings found</TableCell></TableRow>
              ) : (
                payments?.map(p => (
                  <TableRow key={p.id}>
                    ...
                    <TableCell className="text-success font-medium">+{formatCurrency(p.amount, p.currency, lang)}</TableCell>
