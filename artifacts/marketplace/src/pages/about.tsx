...
export default function About() {
  ...
  const fallbackTitle = lang === "ar" ? "عن خِدمة" : "About Atmemly";
  const fallbackBody =
    lang === "ar"
      ...
      : "Atmemly is the premier platform connecting visionary clients with the finest freelance talent across the GCC. Built specifically for the regional market, we understand the nuances of business in the UAE and the wider Middle East.\n\nOur mission is to empower professionals to work flexibly while providing businesses access to vetted, high-quality expertise.";
