...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "section.blog.title": "From the Khidma Blog",
    "section.blog.subtitle": "Tips, guides and stories for freelancers and clients",
    "section.faq.title": "Frequently Asked Questions",
    "section.faq.subtitle": "Everything you need to know about Khidma",
    "section.app.title": "Get the Khidma mobile app",
    ...
    "footer.about":
      "Khidma is a bilingual freelance marketplace for the UAE and the wider GCC region, connecting clients with the best Arab talent.",
  ...
  ar: {
    ...
    "hero.search.placeholder": "ابحث عن أي خدمة…",
    ...
    "section.blog.title": "من مدونة خدمة",
    "section.blog.subtitle": "نصائح وأدلة وقصص للمستقلين والعملاء",
    "section.faq.title": "الأسئلة الشائعة",
    "section.faq.subtitle": "كل ما تحتاج معرفته عن منصة خدمة",
    "section.app.title": "حمّل تطبيق خدمة للجوال",
    ...
    "footer.about":
      "خدمة هي منصة مستقلين ثنائية اللغة للإمارات ودول الخليج، تربط العملاء بأفضل الكفاءات العربية.",
