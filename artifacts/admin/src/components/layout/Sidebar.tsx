...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/cms/blog", label: { ar: "المدونة", en: "Blog" }, icon: BookOpen, resource: "blog" },
      { href: "/cms-blog-categories", label: { ar: "فئات المدونة", en: "Blog categories" }, icon: Layers, resource: "blog" },
      { href: "/cms/faqs", label: { ar: "الأسئلة الشائعة", en: "FAQs" }, icon: HelpCircle, resource: "faqs" },
